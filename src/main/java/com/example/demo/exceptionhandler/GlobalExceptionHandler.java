...
import com.example.demo.exception.ViolationException;
import com.example.demo.validation.ErrorCollector;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseError handleRoleNotFoundException(RoleNotFoundException e) {
        return ResponseError
                .builder()
                .code(ErrorCodes.ERR_CODE_ROLE_NOT_FOUND)
                .message(e.getMessage())
                .data(e.getData())
                .build();
    }
    ...
    @ResponseBody
    public ResponseError handleRoleExistException(RoleAlreadyExistException e) {
        return ResponseError
                .builder()
                .code(ErrorCodes.ERR_CODE_ROLE_ALREADY_EXIST)
                .message(e.getMessage())
                .data(e.getData())
                .build();
    }
